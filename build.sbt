...
ThisBuild / githubWorkflowScalaVersions  := Seq("2.13.7", "2.12.15")
...
libraryDependencies +=  "com.disneystreaming" %% "weaver-scalacheck" % "0.7.10"
libraryDependencies +=  "com.disneystreaming" %% "weaver-cats" % "0.7.10"
